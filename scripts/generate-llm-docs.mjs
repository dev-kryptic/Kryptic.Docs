...
const BASE_URL = 'https://docs.kryptic.dev';
...
function generateLlmsTxt(pages) {
  ...
  let content = `# Kryptic Documentation

> Kryptic is a developer secrets platform that injects environment variables at runtime.
