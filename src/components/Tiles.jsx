...
function TilePattern({ mouseX, mouseY }) {
  ...
  return (
    <div className="pointer-events-none">
      ...
      <motion.div
        className="absolute inset-0 rounded-2xl bg-gradient-to-r from-kryptic to-kryptic-dark opacity-0 transition duration-300 group-hover:opacity-30 dark:group-hover:opacity-60 dark:from-kryptic/30 dark:to-kryptic-dark/30"
        style={style}
      />
      <motion.div
